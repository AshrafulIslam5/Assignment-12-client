...
const Blogs = () => {
    return (
        <div className='p-10'>
            ...
            <div className='bg-primary text-white p-5 rounded-lg mb-5'>
            ...
            <div className='bg-secondary text-white p-5 rounded-lg'>
            ...
            <div className='bg-primary text-white p-5 rounded-lg mt-5'>
